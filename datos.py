...
# CAM1_RECTS = [(0, 200, 150, 480), (530, 350, 640, 480), (465, 100, 590, 300)]
CAM1_RECTS = [(75, 100, 320, 480)]
CAM2_RECTS = [(0, 0, 140, 280),
              (0, 320, 140, 480),
              (500, 80, 640, 320),
              (500, 340, 640, 480)]
CAM3_RECTS = [(410, 70, 500, 250)]
...
# CAM1_LOCS_REL = [AULA_COORD, PASILLO_COORD, "NINGUNO"]
CAM1_LOCS_REL = [AULA_COORD]
...
LOBBY = {"nombre_local": "LOBBY",
         "coordenadas": LOBBY_COORD, "camaras": [CAM1]}
LOCAL1 = {"nombre_local": "LOCAL 1",
          "coordenadas": LOCAL1_COORD, "camaras": []}
LOCAL2 = {"nombre_local": "LOCAL 2",
          "coordenadas": LOCAL2_COORD, "camaras": [CAM5]}
LOCAL3 = {"nombre_local": "LOCAL 3",
          "coordenadas": LOCAL3_COORD, "camaras": [CAM4]}
PASILLO = {"nombre_local": "PASILLO",
           "coordenadas": PASILLO_COORD, "camaras": []}
...
DIRECCION = {"nombre_local": "DIRECCION",
             "coordenadas": DIRECCION_COORD, "camaras": []}
LAB = {"nombre_local": "LABORATORIO", "coordenadas": LAB_COORD, "camaras": []}
LAB2 = {"nombre_local": "LABORATORIO",
